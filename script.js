const IMAGES = {
  "PT": [
    "PT_00.jpeg",PT_01.jpeg","PT_02.jpeg","PT_03.jpeg","PT_04.jpeg","PT_05.jpeg","PT_06.jpeg","PT_07.jpeg","PT_08.jpeg","PT_09.jpeg","PT_10.jpeg","PT_11.jpeg"
  ],
  "EN": [
    "EN_00.jpeg",EN_01.jpeg","EN_02.jpeg","EN_03.jpeg","EN_04.jpeg","EN_05.jpeg","EN_06.jpeg","EN_07.jpeg","EN_08.jpeg","EN_09.jpeg","EN_10.jpeg","EN_11.jpeg"
  ]
};
...
const edgeArrowLeft = document.getElementById("edgeArrowLeft");
const edgeArrowRight = document.getElementById("edgeArrowRight");
const pageShadow = document.getElementById("pageShadow");
const pageFold = document.getElementById("pageFold");
...
function flashEdgeArrow(side) {
  const target = side === "left" ? edgeArrowLeft : edgeArrowRight;
  if (!target) return;
  target.classList.remove("show");
  void target.offsetWidth;
  target.classList.add("show");
  clearTimeout(target._timer);
  target._timer = setTimeout(() => target.classList.remove("show"), 220);
}
...
tapLeft.addEventListener("click", (e) => { e.stopPropagation(); if (consumeToShowUi(e)) return; flashEdgeArrow("left"); goPrev(); });
tapRight.addEventListener("click", (e) => { e.stopPropagation(); if (consumeToShowUi(e)) return; flashEdgeArrow("right"); goNext(); });
